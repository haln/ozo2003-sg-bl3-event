...
passport.use(new SteamStrategy({
    returnURL: 'https://ozo2003-sg-bl3-event.wm.r.appspot.com/auth/steam/return',
    realm: 'https://ozo2003-sg-bl3-event.wm.r.appspot.com/',
...
app.get('/', function(req, res){
  request('https://api.steampowered.com/ISteamNews/GetNewsForApp/v0002/?appid=397540&count=3&maxlength=300&format=json', function (error, response, body) {
    ...
    res.render('index', { user: req.user, data: JSON.stringify(body) });
  });
});
